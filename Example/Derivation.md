...
The large-$begin:math:text$\\xi$end:math:text$ asymptotics are essential for stable numerical quadrature.
...
- non-convergent $begin:math:text$K\_I\,K\_\{II\}$end:math:text$,
